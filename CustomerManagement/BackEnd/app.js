...
app.use(function (req, res, next) {
  res.setHeader("Access-Control-Allow-Origin", "http://ec2-52-53-217-170.us-west-1.compute.amazonaws.com:3000");
...
app.use(
  cors({
    origin: "http://ec2-52-53-217-170.us-west-1.compute.amazonaws.com:3000",
    credentials: true,
  })
);
