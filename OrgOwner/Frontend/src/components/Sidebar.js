...
class SideNav extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            items: [
                { 
                  path: '/OrgOwnerProfile', /* path is used as id to check which NavItem is active basically */
                  name: 'Profile',
        ...
        return(
            ...
            <StyledNavItem active={active}>
                ...
                <Link to={this.props.path}   className={this.props.name} onClick={this.handleClick}>
                    ...
                    <NavIcon> <h5 color = "#FFFFFF" >{this.props.name}</h5></NavIcon>
                </Link>
            </StyledNavItem>
        );
    }
