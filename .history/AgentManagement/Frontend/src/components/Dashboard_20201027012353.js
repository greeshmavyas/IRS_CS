            ...
            <Card>
              <Card.Body>
                ...
                <Table>
                  <tbody>
                    <tr style ={{'show' : false}}>
                      <td style = {{width: '10rem', 'show' : false}}> ID: {ticket.CaseID}</td>
                      <td style = {{width: '15rem', 'show' : false}}>Status: {ticket.Status}</td>
                      <td style = {{width: '50rem', 'show' : false}}>{ticket.Information} </td>
                    </tr>
                  </tbody>
                </Table>
              </Card.Body>
